    ...
    return (
      ...
      <div  class="modal">            <svg preserveAspectRatio="none" viewBox="-0.75 -0.75 801.5 451.5" class="path8"><path d="M 0 0 L 800 0 L 800 450 L 0 450 L 0 0 Z"  /></svg>
            ...
            <div  class="imagePicker">                <div  class="seleccionaUnaFotoParaElUsuario">Selecciona una foto para el usuario</div>
                ...
                <img src={this.state.image} className="nopathCopia6"></img>
            ...
            <input type="text" id="nombre" name="nombre" class="rectangle46" required  minlength="4" maxlength="50" value={this.state.nombres}></input>
            ...
            <input type="text" id="apellidop" name="apellidop" class="rectangle58" required  minlength="4" maxlength="30" value={this.state.apellidoPaterno}></input>
            ...
            <input type="text" id="dni" name="dni" class="rectangle59" required  minlength="7" maxlength="8" value={this.state.apellidoMaterno}></input>
            <div class="xDni8Caracteres"><span class="xDni8Caracteres-0">*</span><span class="xDni8Caracteres-1"> DNI (8 caracteres)</span></div>
            <input type="text" id="phone" name="phone" class="rectangle60" required  minlength="7" maxlength="9" value={this.state.dni}></input>
            ...
            <input type="password" id="pass" name="pass" class="rectangle61" required  minlength="1" maxlength="20" value={this.state.celular}></input>
            ...
            <input type="text" id="address" name="address" class="rectangle63" required  minlength="1" maxlength="70" value={this.state.contrasenia}></input>
